...
namespace Bogardo\EnvironmentConfig\Command;

use Bogardo\EnvironmentConfig\Api\File\FinderInterfaceFactory;
use Bogardo\EnvironmentConfig\Api\Processor\ImportProcessorInterfaceFactory;
...
class ProcessCommand extends AbstractCommand
{
    ...
    /**
     * @var \Bogardo\EnvironmentConfig\Api\Processor\ImportProcessorInterfaceFactory
     */
    ...
    /**
     * @var \Bogardo\EnvironmentConfig\Api\File\FinderInterfaceFactory
     */
     ...
     * @param \Bogardo\EnvironmentConfig\Api\Processor\ImportProcessorInterfaceFactory $importProcessorFactory
     * @param \Bogardo\EnvironmentConfig\Api\File\FinderInterfaceFactory               $finderFactory
     * @param array                                                                   $readers
     * @param null                                                                    $name
     */
    ...
    protected function execute(InputInterface $input, OutputInterface $output): ?int
    {
        ...
        /** @var \Bogardo\EnvironmentConfig\Api\File\FinderInterface $finder */
        $finder = $this->finderFactory->create();
        $finder->setFolder($folder);
        $finder->setFormat($format);

        // Process the import
        /** @var \Bogardo\EnvironmentConfig\Api\Processor\ImportProcessorInterface $processor */
